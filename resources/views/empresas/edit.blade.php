        ...
        <div class="row g-3">
            ...
            <div class="col-md-6 d-flex align-items-end">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" name="ativo" value="1" @checked($empresa->ativo)>
                    <label class="form-check-label">Empresa ativa</label>
                </div>
            </div>
            <div class="col-12">
                <label class="form-label">Observações</label>
                <textarea name="observacoes" class="form-control" rows="4">{{ $empresa->observacoes }}</textarea>
            </div>
        </div>
        <div class="mt-3">
